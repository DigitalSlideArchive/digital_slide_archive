...
var DrawWidget = Panel.extend({
    ...
    render() {
        ...
        if (this.viewer.annotationLayer && !this.viewer.annotationLayer._boundDSAModeChange) {
            this.viewer.annotationLayer._boundDSAModeChange = true;
    ...
    cancelDrawMode() {
        ...
        this.viewer.annotationLayer._boundDSAModeChange = false;
        this.viewer.annotationLayer.geoOff(window.geo.event.annotation.state);
    },
