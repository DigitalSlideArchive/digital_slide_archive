...
RUN cd /opt && \
    ...
    git checkout g5-fix-color-picker && \
...
# needed:
# import-tracker, dicomweb, histomicsui
# abandoned:
# girder-resource-path-tools
# additional:
# clamav, annotation-tracker, girder-assetstore, renalpath, volview, dive
