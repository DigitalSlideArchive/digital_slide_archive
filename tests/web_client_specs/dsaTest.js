(function (global) {
    ...
    function startApp() {
        girderTest.promise = girderTest.promise.then(function () {
            ...
            girder.plugins.digital_slide_archive.panels.DrawWidget.throttleAutosave = false;

            app = new girder.plugins.digital_slide_archive.App({
                el: 'body',
                parentView: null
            });
            app.bindRoutes();
            girder.events.trigger('g:appload.after');
            global.dsaTest.app = app;
            return app;
        });
    }
    ...
    global.dsaTest.waitsForPromise = waitsForPromise;
    global.dsaTest.startApp = startApp;
    global.dsaTest.openImage = openImage;
    global.dsaTest.geojsMap = geojsMap;
    global.dsaTest.imageId = imageId;
    global.dsaTest.login = login;
}(window));
