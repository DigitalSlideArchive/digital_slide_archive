...
girderTest.promise.done(function () {
    ...
    describe('Annotation tests', function () {
        ...
        describe('Annotation styles', function () {
            ...
            it('draw a point', function () {
                ...
                waitsFor(function () {
                    return dsaTest.app.bodyView.drawWidget.collection.length > 0;
                }, 'collection to update');
                runs(function () {
                    var elements = dsaTest.app.bodyView.drawWidget.collection;
        ...
        describe('Annotation panel', function () {
            ...
            it('set the global annotation opacity', function () {
                var opacity;
                var setGlobalAnnotationOpacityFunc = dsaTest.app.bodyView.viewerWidget.setGlobalAnnotationOpacity;
                dsaTest.app.bodyView.viewerWidget.setGlobalAnnotationOpacity = function (_opacity) {
                    opacity = _opacity;
                ...
                dsaTest.app.bodyView.viewerWidget.setGlobalAnnotationOpacity = setGlobalAnnotationOpacityFunc;
            });

            it('set the global annotation fill opacity', function () {
                var opacity;
                var setGlobalAnnotationFillOpacityFunc = dsaTest.app.bodyView.viewerWidget.setGlobalAnnotationFillOpacity;
                dsaTest.app.bodyView.viewerWidget.setGlobalAnnotationFillOpacity = function (_opacity) {
                    opacity = _opacity;
                ...
                dsaTest.app.bodyView.viewerWidget.setGlobalAnnotationFillOpacity = setGlobalAnnotationFillOpacityFunc;
            });
            ...
            it('getElementsInBox', function () {
                var viewer = dsaTest.app.bodyView.viewerWidget;
                var boundingBox = {
                    left: 0,
                    top: 0,
                ...
                runs(function () {
                    var elements = dsaTest.app.bodyView.getElementsInBox(boundingBox);
                    var countExistingElements = dsaTest.app.bodyView.annotations.reduce(function (acc, annotation) {
            ...
            it('edit annotation style', function () {
                ...
                girderTest.waitForLoad();
                runs(function () {
                    var annotation = dsaTest.app.bodyView.annotations.filter(function (annotation) {
            ...
            it('trigger a mouseon event on an element with interactivity off', function () {
                ...
                var element = dsaTest.app.bodyView.annotations.get(annotation).elements().get($('.h-draw-widget .h-element').data('id'));
                dsaTest.app.bodyView.viewerWidget.trigger('g:mouseOnAnnotation', element, annotation);
            ...
            it('trigger a mouseoff event', function () {
                var annotation = $('.h-annotation-selector .h-annotation:contains("drawn 2")').data('id');
                var element = dsaTest.app.bodyView.annotations.get(annotation).elements().get($('.h-draw-widget .h-element').data('id'));
                dsaTest.app.bodyView.viewerWidget.trigger('g:mouseOffAnnotation', element, annotation);
                expect($('.h-annotation-selector .h-annotation:contains("drawn 2")').hasClass('h-highlight-annotation')).toBe(false);
                expect($('.h-draw-widget .h-element').hasClass('h-highlight-element')).toBe(false);
            });
            ...
            it('mouseover an annotation in the AnnotationSelector', function () {
                var called;
                var highlightAnnotation = dsaTest.app.bodyView.viewerWidget.highlightAnnotation;
                dsaTest.app.bodyView.viewerWidget.highlightAnnotation = function (annotation, element) {
                    called = true;
                    expect(annotation).toBe($('.h-annotation-selector .h-annotation:contains("drawn 2")').data('id'));
                    expect(element).toBeUndefined();
                };
                dsaTest.app.bodyView.annotationSelector.$('.h-annotation:contains("drawn 2")').trigger('mouseenter');
                expect(called).toBe(true);
                dsaTest.app.bodyView.viewerWidget.highlightAnnotation = highlightAnnotation;
            });
            ...
            it('show new annotations during job events', function () {
                ...
                runs(function () {
                    ...
                    girder.rest.restRequest({
                        url: 'annotation?itemId=' + dsaTest.imageId(),
            ...
            it('open a different image', function () {
                dsaTest.waitsForPromise(
                    dsaTest.openImage('copy').done(function () {
            ...
            it('open the original image', function () {
                dsaTest.waitsForPromise(
                    dsaTest.openImage('image').done(function () {
    ...
    describe('Open recently annotated image', function () {
        ...
        it('reset filter', function () {
            ...
            dsaTest.waitsForPromise(restPromise, 'Name filter to reset');
        ...
        it('click on the image', function () {
            ...
            runs(function () {
                var imageId = dsaTest.imageId();
                expect(girder.plugins.digital_slide_archive.router.getQuery('image')).toBe(imageId);
            });
        });
    });
    ...
    describe('Annotation tests as admin', function () {
        describe('setup', function () {
            ...
            it('open the dialog', function () {
                ...
                waitsFor(function () {
                    var $el = $('.h-annotated-image[data-id="' + dsaTest.imageId() + '"]');
                    return $el.length === 1;
                }, 'here');
                girderTest.waitForDialog();
                runs(function () {
                    ...
                    expect($el.length).toBe(1);
                    // remock Webgl
                    dsaTest.app.bodyView.once('h:viewerWidgetCreated', function (viewerWidget) {
            ...
            it('set the default style groups', function () {
                ...
                waitsFor(function () {
                    var resp = girder.rest.restRequest({
                        url: 'system/setting',
                        method: 'GET',
                        data: {list: JSON.stringify(['digital_slide_archive.default_draw_styles'])},
                        async: false
                    });
